...
def save_image(tensor, path):
    ...
    superimpose_images("bird.jpeg", path, alpha1=0.3, alpha2=0.7, output_path='output.png')
    
def superimpose_images(image1_path, image2_path, alpha1=0.1, alpha2=0.9, output_path='output.png'):
    # Open both images
    ...
    img1_with_alpha = Image.blend(img1, Image.new('RGBA', img1.size, (0, 0, 0, 0)), alpha1)
    img2_with_alpha = Image.blend(img2, Image.new('RGBA', img2.size, (0, 0, 0, 0)), alpha2)
